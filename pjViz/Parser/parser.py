...
class ExpressionParser(object):
    ...
    def binop(self, p, ctor):
        if len(p) == 2:
            ...
            p[0] = ctor(p[2], p[1], p[3], p.lexer.lineno)
...
class StatementParser(object):
    ...
    def p_if_then_else_statement(self, p):
        ...
        p[0] = IfThenElse(p[3], p[5], p[7], p.lexer.lineno - 1)
    ...
    def p_return_statement(self, p):
        ...
        p[0] = Return(p[2], p.lexer.lineno - 2)
    ...
    def p_throw_statement(self, p):
        ...
        p[0] = Throw(p[2], p.lexer.lineno - 2)
    ...
    def p_class_instance_creation_expression(self, p):
        ...
        p[0] = InstanceCreation(p[3], p.lexer.lineno - 1, type_arguments=p[3], arguments=p[5], body=p[7])
    ...
    def p_class_instance_creation_expression2(self, p):
        ...
        p[0] = InstanceCreation(p[2], p.lexer.lineno - 1, arguments=p[4], body=p[6])
    ...
    def p_class_instance_creation_expression3(self, p):
        ...
        p[0] = InstanceCreation(p[5], p.lexer.lineno - 1, enclosed_in=p[1], type_arguments=p[4], arguments=p[7], body=p[9])
    ...
    def p_class_instance_creation_expression4(self, p):
        ...
        p[0] = InstanceCreation(p[4], p.lexer.lineno - 1, enclosed_in=p[1], arguments=p[6], body=p[8])
    ...
    def p_class_instance_creation_expression5(self, p):
        ...
        p[0] = InstanceCreation(p[3], p.lexer.lineno - 1, enclosed_in=p[1], arguments=p[5], body=p[7])
    ...
    def p_class_instance_creation_expression6(self, p):
        ...
        p[0] = InstanceCreation(p[4], p.lexer.lineno - 1, enclosed_in=p[1], type_arguments=p[3], arguments=p[6], body=p[8])
...
class ClassParser(object):
    ...
    def p_constructor_declaration(self, p):
        ...
        p[0] = ConstructorDeclaration(p[1]['name'], p[2], modifiers=p[1]['modifiers'],
                                      type_parameters=p[1]['type_parameters'],
                                      parameters=p[1]['parameters'], throws=p[1]['throws'], line_num=p[1]['line_num'])
    ...
    def p_method_declaration(self, p):
        ...
        if len(p) == 2:
            ...
            p[0] = MethodDeclaration(p[1]['name'], parameters=p[1]['parameters'],
                                     ...
                                     throws=p[1]['throws'], body=p[2], line_num=p[1]['line_num'])
