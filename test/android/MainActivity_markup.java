...
System.out.println("push method onCreate");
    ...
    {
System.out.println("push method onResume");
    	super.onResume();
...
System.out.println("push method onTabUnselected");
...
System.out.println("push method onTabSelected");
...
System.out.println("push method onTabReselected");
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        {
System.out.println("push method getItemPosition");
        	return POSITION_NONE;
        }

        @Override
        public Fragment getItem(int i) {
System.out.println("push method getItem");
            switch (i) {
                case 0:
        ...
        @Override
        public int getCount() {
System.out.println("push method getCount");
            return 3;
        }

        @Override
        public CharSequence getPageTitle(int position) {
System.out.println("push method getPageTitle");
        	switch(position) {
...
System.out.println("push method startTimer");
	...
	{
System.out.println("push method stopTimer");
		thr.interrupt();
		strDate = null;
...
System.out.println("push method startThread");
		if (!thr.isAlive())
			thr.start();
	}
...
System.out.println("push method handleWBChange");
    ...
    {
System.out.println("push method dismissDialog");
    	if (singleAlert != null)
    	{
...
System.out.println("push method handleStop");
...
System.out.println("push method setState");
		LocalBroadcastManager.getInstance(this).sendBroadcast(
...
System.out.println("push method getState");
		LocalBroadcastManager.getInstance(this).sendBroadcast(
	...
	{
System.out.println("push method getGeofenceRequester");
		return geoRequester;
	}
	/*
...
System.out.println("push method onReceive");
...
System.out.println("push method onReceive");
		...
		{	
System.out.println("push method handleGeofenceTransition");
		...
		{
System.out.println("push method handleGeofenceError");
...
System.out.println("push method addActivity");
		LocalBroadcastManager.getInstance(this).sendBroadcast(
...
System.out.println("push method deleteActivity");
		LocalBroadcastManager.getInstance(this).sendBroadcast(
...
System.out.println("push method getMainActivityContext");
		return this;
	}
	/*
	 * Method: getDaily
...
System.out.println("push method getDaily");
		LocalBroadcastManager.getInstance(this).sendBroadcast(
...
System.out.println("push method getLocation");
	...
	{
System.out.println("push method dialogDismissed");
		mViewPager.getAdapter().notifyDataSetChanged();
	}
...
System.out.println("push method addPersistantGeofence");
	...
	{
System.out.println("push method getNextID");
		return geoID;
	}
	/*
	 * Method: addDay
...
System.out.println("push method addDay");
...
System.out.println("push method getCal");
		return actDate;
	}
